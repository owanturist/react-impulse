...
#### `scope: Scope{:ts}` [#impulse-get-value-scope]

### `setValue(value){:ts}` [#impulse-set-value]

#### `value: T{:ts}` [#impulse-set-value-value]

### `setValue(transform){:ts}` [#impulse-set-value-transform]

#### `transform: Transform<T>{:ts}` [#impulse-set-value-transform]

### `clone(options?){:ts}` [#impulse-clone]

#### `options?: ImpulseOptions<T>{:ts}` [#impulse-clone-options]

### `clone(transform, options?){:ts}` [#impulse-clone-transform]

#### `transform: Transform<T>{:ts}` [#impulse-clone-transform-transform]

#### `options?: ImpulseOptions<T>{:ts}` [#impulse-clone-transform-options]
...
### `compare?: null | Compare<T>{:ts}` [#impulse-options-compare]
...
A shortcut to create a new `Impulse<undefined | T>{:ts}` with an initial value of `undefined{:ts}`.
