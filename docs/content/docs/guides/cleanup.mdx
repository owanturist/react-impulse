...
2. **On disposal** - When `stop()` is called on the effect
...
- [effect API](/docs/api/effect) - Complete API reference
- [Common Patterns](/docs/guides/common-patterns) - More effect patterns
