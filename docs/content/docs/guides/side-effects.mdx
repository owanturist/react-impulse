...
<Callout>
`effect` works inside `useEffect` because React runs effect callbacks outside the render phase. See [How Signals Work in React](/docs/concepts/how-signals-work-in-react) for details on why this is safe.
</Callout>
