...
description: Patterns for reading and updating signals in components and hooks
---
...
The empty dependency array `[]{:ts}` tells React the compute function doesn't depend on any React state or props.
...
<Cards>
  ...
  <Card title="Optimization" description="Batching and performance" href="/docs/guides/optimization" />
</Cards>
