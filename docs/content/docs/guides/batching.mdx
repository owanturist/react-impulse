...
<Cards>
  ...
  <Card title="Effects" description="How effects respond to changes" href="/docs/concepts/effects" />
  <Card title="Performance Optimization" description="More optimization techniques" href="/docs/guides/performance" />
</Cards>
