...
The `effect{:dart}` function creates a reactive effect that runs whenever its signal dependencies change.
...
<Cards>
  <Card title="Core Reactivity" description="Core signal concepts" href="/docs/concepts/fundamentals" />
