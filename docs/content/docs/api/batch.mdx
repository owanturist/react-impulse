...
- [Batching Updates](/docs/guides/batching) - Detailed guide with patterns
- [effect](/docs/api/effect) - Creating reactive effects
- [untracked](/docs/api/untracked) - Reading without tracking
