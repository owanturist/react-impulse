...
// Logs: "Current temperature: 25°C"

temperature.write(30)
// Logs: "Current temperature: 30°C"
```
...
<Accordions>
  <Accordion id="exercise-1-hint" title="Hint">
...
<Accordions>
  <Accordion id="exercise-3-hint" title="Hint">
...
<Cards>
  <Card title="Derived Signals" description="Learn about computed values and chaining" href="/docs/concepts/derived" />
  <Card title="Effects" description="Side effects and cleanup patterns" href="/docs/concepts/effects" />
  <Card title="React Integration" description="How signals work with React" href="/docs/concepts/react-integration" />
  <Card title="API Reference" description="Complete API documentation" href="/docs/api/signal" />
</Cards>
