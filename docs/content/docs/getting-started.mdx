...
The `useComputed{:dart}` hook connects signals to React components:
...
<Cards>
  <Card title="Fundamentals" description="Core concepts: signals, monitors, effects" href="/docs/concepts/fundamentals" />
  ...
  <Card title="API" description="Complete API documentation" href="/docs/api/signal" />
</Cards>
