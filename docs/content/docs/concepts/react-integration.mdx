...
<Cards>
  ...
  <Card title="useMonitor API" description="Low-level monitor access" href="/docs/api/use-monitor" />
  <Card title="Using Signals in React Components" description="Practical patterns" href="/docs/guides/react-components" />
</Cards>
