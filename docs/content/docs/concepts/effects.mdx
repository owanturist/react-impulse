...
<Cards>
  <Card title="effect API Reference" description="Complete API documentation" href="/docs/api/effect" />
  <Card title="Signals and Monitors" description="Core reactive primitives" href="/docs/concepts/signals" />
  <Card title="Resource Cleanup" description="Cleanup patterns in detail" href="/docs/guides/cleanup" />
  <Card title="Batching Updates" description="Batching guide" href="/docs/guides/batching" />
</Cards>
