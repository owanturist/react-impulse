  ...
  describe("single impulse", () => {
    ...
    it("can watch inside useScopedMemo", () => {
      ...
      render(
        <React.Profiler id="test" onRender={onRender}>
          <Component onMemo={onMemo} useMemo={useScopedMemo} value={value} />
        </React.Profiler>,
      )
    ...
    it("does not call useMemo factory when deps not changed", () => {
      ...
      const { rerender } = render(
        <React.Profiler id="test" onRender={onRender}>
          <Component useMemo={useScopedMemo} onMemo={onMemo} value={value} />
        </React.Profiler>,
      )
    ...
    it("should call useMemo factory when dep Impulse changes", () => {
      ...
      const { rerender } = render(
        <React.Profiler id="test" onRender={onRender}>
          <Component useMemo={useScopedMemo} onMemo={onMemo} value={value_1} />
        </React.Profiler>,
      )
      vi.clearAllMocks()
      ...
      rerender(
        <React.Profiler id="test" onRender={onRender}>
          <Component useMemo={useScopedMemo} onMemo={onMemo} value={value_2} />
        </React.Profiler>,
      )
